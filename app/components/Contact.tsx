        ...
        <div className="grid md:grid-cols-2 gap-12 animate-fade-in-delay-2">
          <div className="bg-white dark:bg-gray-800 p-8 rounded-2xl shadow-lg hover:shadow-xl transition-shadow transform hover:-translate-y-1">
            ...
            <div className="space-y-4">
              <a
                href="mailto:ajitdink@usc.edu"
                className="text-blue-600 dark:text-blue-400 hover:text-blue-800 dark:hover:text-blue-300 flex items-center gap-3 group"
              >
                <span className="bg-blue-100 dark:bg-blue-900/50 p-2 rounded-lg group-hover:bg-blue-200 dark:group-hover:bg-blue-800/50 transition-colors">
                  <svg
                ...
                <span className="font-medium">ajitdink@usc.edu</span>
              </a>
              
              <a
                href="https://linkedin.com/in/ajitbhandarkar"
                target="_blank"
          ...
          <div className="bg-white dark:bg-gray-800 p-8 rounded-2xl shadow-lg hover:shadow-xl transition-shadow transform hover:-translate-y-1">
            ...
            <div className="mt-6">
              <h4 className="font-semibold mb-2 text-gray-900 dark:text-white">Preferred Working Hours</h4>
